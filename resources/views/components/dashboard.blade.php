    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ request()->routeIs('admin.categories.index') || request()->routeIs('admin.categories.create')? 'active' : ''}}">
                ...
                <div id="collapseCategories" class="collapse {{ request()->routeIs('admin.categories.index') || request()->routeIs('admin.categories.create')? 'show' : ''}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            ...
            <!-- Divider -->
            <hr class="sidebar-divider my-0">
            <!-- Nav Item - Pages Collapse Menu Tags -->
            <li class="nav-item {{ request()->routeIs('admin.tags.index') || request()->routeIs('admin.tags.create')? 'active' : ''}}">
                ...
                <div id="collapseTags" class="collapse {{ request()->routeIs('admin.tags.index') || request()->routeIs('admin.tags.create')? 'show' : ''}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item  {{ request()->routeIs('admin.tags.index') ? 'active' : ''}}" href="{{ route('admin.tags.index') }}">All Tags</a>
                        <a class="collapse-item {{ request()->routeIs('admin.tags.create') ? 'active' : ''}}" href="{{ route('admin.tags.create') }}">Add New</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item {{ request()->routeIs('admin.posts.index') || request()->routeIs('admin.posts.create')? 'active' : ''}}">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePosts"
                    aria-expanded="true" aria-controls="collapsePosts">
                    <i class="fas fa-fw fa-newspaper"></i>
                    <span>Posts</span>
                </a>
                <div id="collapsePosts" class="collapse {{ request()->routeIs('admin.posts.index') || request()->routeIs('admin.posts.create')? 'show' : ''}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item {{ request()->routeIs('admin.posts.index') ? 'active' : ''}}" href="{{ route('admin.posts.index') }}">All Posts</a>
                        <a class="collapse-item {{ request()->routeIs('admin.posts.create') ? 'active' : ''}}" href="{{ route('admin.posts.create') }}">Add New</a>
                    </div>
                </div>
            </li>
